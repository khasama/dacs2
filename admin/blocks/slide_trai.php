<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Tùy chỉnh các thành phần:</h6>
                <a class="collapse-item" href="buttons.html">Các nút</a>
                <a class="collapse-item" href="cards.html">Các thẻ</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Tùy chỉnh các tiện ích:</h6>
                <a class="collapse-item" href="utilities-color.html">Màu</a>
                <a class="collapse-item" href="utilities-border.html">Khung</a>
